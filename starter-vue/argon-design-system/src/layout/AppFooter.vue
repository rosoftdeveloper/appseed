            ...
            <div class="row">
                <div class="col-md-6 mb-5 mb-md-0">
                    <div class="card card-lift--hover shadow border-0">
                        <router-link to="/components" title="Landing Page">
                            <img v-lazy="'img/theme/components.jpg'" class="card-img">
                        </router-link>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row row-grid align-items-center my-md">
                ...
                <div class="col-lg-6 text-lg-center btn-wrapper">
                    ...
                    <a target="_blank" href="https://twitter.com/webappseed"
                       class="btn btn-neutral btn-icon-only btn-twitter btn-round btn-lg" data-toggle="tooltip"
                       data-original-title="Follow us">
                        <i class="fa fa-twitter"></i>
                    </a>

                    <a target="_blank" href="https://www.facebook.com/webappseed"
                       class="btn btn-neutral btn-icon-only btn-facebook btn-round btn-lg" data-toggle="tooltip"
                       data-original-title="Like us">
                        <i class="fa fa-facebook-square"></i>
                    </a>

                    <a target="_blank" href="https://github.com/rosoftdeveloper/appseed"
            ...
            <div class="row align-items-center justify-content-md-between">
                ...
                <ul class="nav nav-footer justify-content-end">
                    <li class="nav-item">
                    <a href="https://appseed.us/fullstack-apps-generator" class="nav-link" target="_blank">AppSeed - Full stack app generator</a>
                    </li> 
                </ul>
                </div>
            </div>

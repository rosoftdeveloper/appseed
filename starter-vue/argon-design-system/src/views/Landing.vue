            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <p class="lead  text-white">
                  JWT token authentication. The design system (by Creative-Tim)
                  comes with four pre-built pages to help you get started
                  faster.
                </p>
                <div class="btn-wrapper">
                  <p class="lead text-white">
                    This web app can be generated in Vue.js combined with
                    Express / Flask or Laravel. Your choice :)
                  </p>
                  <a
                    target="_blank"

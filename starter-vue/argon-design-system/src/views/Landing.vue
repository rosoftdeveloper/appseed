                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">Full Stack Web App
                                    <span>Built with AppSeed</span>
                                </h1>
                                <p class="lead  text-white">JWT token authentication.
                                ...
                                <a target="_blank" href="https://appseed.us/fullstack-apps-generator/vuejs" 
                                   class="btn btn-white btn-icon mb-3 mb-sm-0">
                                    <i style="color: red" class="fa fa-rocket"></i>
                                    <span class="btn-inner--text">Full Stack App Generator</span>
                                </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="pl-md-5">
                            ...
                            <p>The kit comes with three pre-built pages to help you get started faster. You can change
                                the text and images and you're good to go.</p>
                            <a target="_blank" href="https://appseed.us/fullstack-apps-generator/vuejs" 
                               class="font-weight-bold text-warning mt-5">Build this app in Vue.js</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="p-5">
                ...
                <div class="col-lg-3 ml-lg-auto">
                    <a target="_blank" href="https://appseed.us/fullstack-apps-generator/vuejs" class="btn btn-lg btn-block btn-white">Build with AppSeed</a>
                </div>
                </div>
            </div>
            </div>
      ...
      <div class="container">
        <div class="row row-grid justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="btn-wrapper">
              <a href="https://appseed.us/fullstack-apps-generator/vuejs" class="btn btn-primary mb-3 mb-sm-0">Build this app in Vue.js</a>
            </div>
            <div class="text-center">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-2 col-4">
                  <a href="#" target="_blank" data-toggle="tooltip" data-original-title="[Coming Soon] React - A JavaScript library for building user interfaces">

...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="./index.html">
            <img src="{{asset(config('themes.assets.' . session('theme')) . '/assets/img/brand/blue.png')}}" class="navbar-brand-img" alt="...">
        </a>
        <!-- User -->
        <ul class="nav align-items-center d-md-none">
            ...
            <li class="nav-item dropdown">
              ...
              <span class="avatar avatar-sm rounded-circle">
                <img alt="Image placeholder" src="{{asset(config('themes.assets.' . session('theme')) . '/assets/img/theme/team-1-800x800.jpg')}}">
              </span>
                    </div>
                </a>

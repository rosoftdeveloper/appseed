<header class="header-global">
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light headroom">
        <div class="container">
            <a class="navbar-brand mr-lg-5" href="{{url('/theme/argon2')}}">
                <img src="{{asset(config('themes.assets.' . session('theme')) . '/assets/img/brand/white.png')}}">
            </a>
            ...
            <div class="navbar-collapse collapse" id="navbar_global">
                <div class="navbar-collapse-header">
                    <div class="row">
                        <div class="col-6 collapse-brand">
                            <a href="{{url('/theme/argon2')}}">
                                <img src="{{asset(config('themes.assets.' . session('theme')) . '/assets/img/brand/blue.png')}}">
                            </a>
                        </div>
                ...
                <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                    ...
                    <li class="nav-item d-none d-lg-block ml-lg-4">
                        @guest
                            <a href="{{route('login')}}" class="btn btn-neutral"><span class="nav-link-inner--text">{{__(session('theme').'.login')}}</span></a>
                        @else
                            <a href="{{ route('logout') }}" class="btn btn-neutral" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                <span class="nav-link-inner--text">{{__(session('theme').'.logout')}}</span>
                            </a>

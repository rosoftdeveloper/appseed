            ...
            <div class="navbar-collapse collapse" id="navbar_global">
                ...
                <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link" data-toggle="dropdown" href="#" role="button">
                            <i class="ni ni-collection d-lg-none"></i>
                            <span class="nav-link-inner--text"><?php echo e(__(session('theme').'.language')); ?> (<?php echo e(strtoupper(app()->getLocale())); ?>)</span>
                        </a>
                        <div class="dropdown-menu">
                            <?php $__currentLoopData = config('app.available_locale'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(url('/locale') . '/' . $locale); ?>" class="dropdown-item"><?php echo e(strtoupper($locale)); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </li>
                    <li class="nav-item">
                        <?php if(auth()->guard()->guest()): ?>
                            <a href="<?php echo e(route('login')); ?>" class="nav-link"><?php echo e(__(session('theme').'.login')); ?></a>
                        <?php else: ?>
                            <a href="<?php echo e(route('logout')); ?>" class="nav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                <?php echo e(__(session('theme').'.logout')); ?>

<div class="pricing-2">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-pricing card-background card-raised" style="background-image: url('<?php echo e(asset(config('themes.assets.' . session('theme')) . '/assets/img/pricing2.jpg')); ?>')">
                    <div class="card-body">

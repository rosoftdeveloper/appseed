...
<?php echo $__env->make(config('themes.view_path.' . session('theme')) . 'sections.google-tag-manager', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make(config('themes.view_path.' . session('theme')) . 'sections.nav', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<div class="testimonials-1 section-image" style="background-image: url('<?php echo e(asset(config('themes.assets.' . session('theme')) . '/assets/img/bg19.jpg')); ?>')">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card card-testimonial">
                    <div class="card-avatar">
                        <a href="#pablo">
                            <img class="img img-raised" src="<?php echo e(asset(config('themes.assets.' . session('theme')) . '/assets/img/michael.jpg')); ?>">
                        </a>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card card-testimonial">
                    <div class="card-avatar">
                        <a href="#pablo">
                            <img class="img img-raised" src="<?php echo e(asset(config('themes.assets.' . session('theme')) . '/assets/img/olivia.jpg')); ?>">
                        </a>
                    </div>
                    <div class="card-body">
                        <p class="card-description">
            ...
            <div class="col-md-4">
                <div class="card card-testimonial">
                    <div class="card-avatar">
                        <a href="#pablo">
                            <img class="img img-raised" src="<?php echo e(asset(config('themes.assets.' . session('theme')) . '/assets/img/james.jpg')); ?>">
                        </a>
                    </div>
                    <div class="card-body">
                        <p class="card-description">

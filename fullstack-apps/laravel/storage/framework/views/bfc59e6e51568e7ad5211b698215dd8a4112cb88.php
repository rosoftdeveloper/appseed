        ...
        <div class="container">
            <div class="row row-grid align-items-center">
                <div class="col-md-6 order-md-2">
                    <img src="<?php echo e(asset(config('themes.assets.' . Request::segment(2)) . '/assets/img/theme/promo-1.png')); ?>" class="img-fluid floating">
                </div>
            ...
            <div class="row row-grid align-items-center">
                <div class="col-md-6">
                    <div class="card bg-default shadow border-0">
                        <img src="<?php echo e(asset(config('themes.assets.' . Request::segment(2)) . '/assets/img/theme/img-1-1200x1000.jpg')); ?>" class="card-img-top">
            ...
            <div class="row row-grid align-items-center">
                <div class="col-md-6 order-lg-2 ml-lg-auto">
                    <div class="position-relative pl-md-5">
                        <img src="<?php echo e(asset(config('themes.assets.' . Request::segment(2)) . '/assets/img/ill/ill-2.svg')); ?>" class="img-center img-fluid">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                    <div class="px-4">
                        <img src="<?php echo e(asset(config('themes.assets.' . Request::segment(2)) . '/assets/img/theme/team-1-800x800.jpg')); ?>" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
                ...
                <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                    <div class="px-4">
                        <img src="<?php echo e(asset(config('themes.assets.' . Request::segment(2)) . '/assets/img/theme/team-2-800x800.jpg')); ?>" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
                        <div class="pt-4 text-center">
                            <h5 class="title">
                ...
                <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                    <div class="px-4">
                        <img src="<?php echo e(asset(config('themes.assets.' . Request::segment(2)) . '/assets/img/theme/team-3-800x800.jpg')); ?>" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
                        <div class="pt-4 text-center">
                            <h5 class="title">
                ...
                <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                    <div class="px-4">
                        <img src="<?php echo e(asset(config('themes.assets.' . Request::segment(2)) . '/assets/img/theme/team-4-800x800.jpg')); ?>" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
                        <div class="pt-4 text-center">
                            <h5 class="title">

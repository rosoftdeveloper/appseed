            ...
            <div class="col-md-6 mb-5 mb-md-0">
                <div class="card card-lift--hover shadow border-0">
                    <a href="../examples/landing.html" title="Landing Page">
                        <img src="<?php echo e(asset(config('themes.assets.' . session('theme')) . '/assets/img/theme/landing.jpg')); ?>" class="card-img">
                    </a>
                </div>
            </div>
            <div class="col-md-6 mb-5 mb-lg-0">
                <div class="card card-lift--hover shadow border-0">
                    <a href="../examples/profile.html" title="Profile Page">
                        <img src="<?php echo e(asset(config('themes.assets.' . session('theme')) . '/assets/img/theme/profile.jpg')); ?>" class="card-img">
                    </a>
                </div>
            </div>
        </div>

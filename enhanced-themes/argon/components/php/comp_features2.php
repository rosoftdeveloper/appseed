   ...
   <div class="row row-grid align-items-center">
    <div class="col-md-6 order-lg-2 ml-lg-auto">
     <div class="position-relative pl-md-5">
      <img class="img-center img-fluid" src="https://www.argon-design-system-enh.appseed.us/assets/img/ill/ill-2.svg"/>
     </div>
    </div>
     ...
     <div class="d-flex px-3">
      ...
      <div class="pl-4">
       <h4 class="display-3 text-white">
        <?php echo $features2_var_1?>
       </h4>
       <p class="text-white">
        <?php echo $features2_var_2?>
       </p>
      </div>
     </div>
       ...
       <div class="d-flex px-3">
        ...
        <div class="pl-4">
         <h5 class="title text-success">
          <?php echo $features2_var_3?>
         </h5>
         <p>
          <?php echo $features2_var_4?>
         </p>
         <a class="text-success" href="#">
          <?php echo $features2_var_5?>
         </a>
        </div>
       </div>
      </div>
       ...
       <div class="d-flex px-3">
        ...
        <div class="pl-4">
         <h5 class="title text-warning">
          <?php echo $features2_var_6?>
         </h5>
         <p>
          <?php echo $features2_var_7?>
         </p>
         <a class="text-warning" href="#">
          <?php echo $features2_var_8?>
         </a>
        </div>
       </div>
      </div>

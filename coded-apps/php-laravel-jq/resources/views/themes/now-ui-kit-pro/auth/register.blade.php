@extends(config('themes.assets.' . session('theme')) . '.layouts.register')

@section('content')

        <div class="page-header-image" style="background-image:url('{{asset(config('themes.assets.' . session('theme')) . '/assets/img/bg18.jpg')}}')"></div>
        <div class="content">
            <div class="container">
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Name..." autocomplete="fullname" name="name" value="{{ old('name') }}" required autofocus>
                                    </div>
                                    {{--<div class="input-group">--}}
                                        {{--<div class="input-group-prepend">--}}
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Your Email..." autocomplete="email" name="email" value="{{ old('email') }}" required>
                                    </div>

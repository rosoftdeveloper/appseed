    ...
    <div class="wrapper">
        <div class="page-header section-dark" style="background-image: url('/static/themes/<?php echo $theme; ?>/assets/img/antoine-barres.jpg')">
    		...
    		<div class="content-center">
    			<div class="container">
    				<div class="title-brand">
    					...
    					<div class="fog-low">
    						<img src="/static/themes/<?php echo $theme; ?>/assets/img/fog-low.png" alt="">
    					</div>
            ...
            <div class="moving-clouds" style="background-image: url('/static/themes/<?php echo $theme; ?>/assets/img/clouds.png'); ">
        ...
        <div class="main">
                    	...
                    	<div class="container">
                            ...
                            <div class="row">
                                <div class="col-8 col-sm-6 col-md-3">
                                    ...
                                    <img src="/static/themes/<?php echo $theme; ?>/assets/img/uriel-soberanes.jpg" class="img-rounded img-responsive" alt="Rounded Image">
                                    <div class="img-details">
                                        <div class="author">
                                            <img src="/static/themes/<?php echo $theme; ?>/assets/img/faces/clem-onojeghuo-2.jpg" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                                        </div>
                                        <p>Chet Faker</p>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-3 col-md-2 mr-auto  ml-auto">
                                    ...
                                    <img src="/static/themes/<?php echo $theme; ?>/assets/img/faces/joe-gardner-2.jpg" class="img-circle img-no-padding img-responsive" alt="Rounded Image">
                                    <p class="text-center">Joe Gardner</p>
                                </div>
                                <div class="col-6 col-sm-3 col-md-2 mr-auto">
                                    <h4 class="images-title">Thumbnail</h4>
                                    <img src="/static/themes/<?php echo $theme; ?>/assets/img/faces/clem-onojeghuo-3.jpg" class="img-thumbnail img-responsive" alt="Rounded Image">
            ...
            <div class="section section-image section-login" style="background-image: url('/static/themes/<?php echo $theme; ?>/assets/img/login-image.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 ml-auto mr-auto">
                            ...
                            <div class="col text-center">
                                <a href="<?php echo base_url('register'); ?>" class="btn btn-outline-neutral btn-round btn-lg" >View Register Page</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row example-page">
                        <div class="col-md-6 text-center">
                            <a href="<?php echo base_url(); ?>" target="_blank">
                                <img src="/static/themes/<?php echo $theme; ?>/assets/img/examples/landing-page.jpg" alt="Rounded Image" class="img-rounded img-responsive" style="width: 100%">
                                <a href="<?php echo base_url(); ?>" class="btn btn-outline-neutral btn-round">Landing Page</a>
                            </a>
                        </div>
                        <div class="col-md-6 text-center">
                            <a href="<?php echo base_url('profile'); ?>" target="_blank">
                                <img src="/static/themes/<?php echo $theme; ?>/assets/img/examples/profile-page.jpg" alt="Rounded Image" class="img-rounded img-responsive" style="width: 100%">
                                <a href="<?php echo base_url('profile'); ?>" class="btn btn-outline-neutral btn-round">Profile Page</a>
                            </a>
                        </div>
                    </div>
                </div>
				...
				<div class="container text-center">
					<div class="row">
						...
						<div class="col-md-5 ml-auto mr-auto download-area">
							<a href="http://www.creative-tim.com/product/paper-kit-2" class="btn btn-danger btn-round">Download HTML</a>
							<a href="https://github.com/rosoftdeveloper/appseed/tree/master/apps/paper-kit" class="btn btn-simple btn-round">Download This App</a>
						</div>
					</div>

        ...
        <div class="page-header clear-filter" filter-color="orange">
            <div class="page-header-image" data-parallax="true" style="background-image: url('/static/themes/<?php echo $theme; ?>/assets/img/header.jpg');">
            </div>
            <div class="container">
                <div class="content-center brand">
                    <img class="n-logo" src="/static/themes/<?php echo $theme; ?>/assets/img/now-logo.png" alt="">
                    <h1 class="h1-seo">Now UI Kit.</h1>
                    <h3>A beautiful Bootstrap 4 UI kit. Yours free.</h3>
                </div>
                <h6 class="category category-absolute">Designed by
                    <a href="http://invisionapp.com/" target="_blank">
                        <img src="/static/themes/<?php echo $theme; ?>/assets/img/invision-white-slim.png" class="invision-logo" />
                    </a>. Coded by
                    <a href="https://www.creative-tim.com" target="_blank">
                        <img src="/static/themes/<?php echo $theme; ?>/assets/img/creative-tim-white-slim2.png" class="creative-tim-logo" />
                    </a>.</h6>
            </div>
        </div>
        ...
        <div class="main">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="hero-images-container">
                                <img src="/static/themes/<?php echo $theme; ?>/assets/img/hero-image-1.png" alt="">
                            </div>
                            <div class="hero-images-container-1">
                                <img src="/static/themes/<?php echo $theme; ?>/assets/img/hero-image-2.png" alt="">
                            </div>
                            <div class="hero-images-container-2">
                                <img src="/static/themes/<?php echo $theme; ?>/assets/img/hero-image-3.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="section section-navbars">
                        ...
                        <div class="col-md-6">
                            ...
                            <nav class="navbar navbar-expand-lg bg-primary">
                                <div class="container">
                                    ...
                                    <div class="collapse navbar-collapse" id="example-navbar" data-nav-image="/static/themes/<?php echo $theme; ?>/assets/img/blurred-image-1.jpg">
                                        <ul class="navbar-nav">
                ...
                <div id="navbar">
                    <div class="navigation-example" style="background-image:url('/static/themes/<?php echo $theme; ?>/assets/img/bg7.jpg')">
                        <!-- Navbar Primary  -->
                        <nav class="navbar navbar-expand-lg bg-primary">
                            <div class="container">
                    ...
                    <div id="images">
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                ...
                                <img src="/static/themes/<?php echo $theme; ?>/assets/img/avatar.jpg" alt="Rounded Image" class="rounded">
                            </div>
                            <div class="col-sm-2">
                                <p class="category">Circle Image</p>
                                <img src="/static/themes/<?php echo $theme; ?>/assets/img/avatar.jpg" alt="Circle Image" class="rounded-circle">
                            </div>
                            <div class="col-sm-2">
                                <p class="category">Raised</p>
                                <img src="/static/themes/<?php echo $theme; ?>/assets/img/avatar.jpg" alt="Raised Image" class="rounded img-raised">
                            </div>
                            <div class="col-sm-2">
                                <p class="category">Circle Raised</p>
                                <img src="/static/themes/<?php echo $theme; ?>/assets/img/avatar.jpg" alt="Thumbnail Image" class="rounded-circle img-raised">
                            </div>
                        </div>
                        <div class="row">
                        </div>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <img class="d-block" src="/static/themes/<?php echo $theme; ?>/assets/img/bg1.jpg" alt="First slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h5>Nature, United States</h5>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block" src="/static/themes/<?php echo $theme; ?>/assets/img/bg3.jpg" alt="Second slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h5>Somewhere Beyond, United States</h5>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block" src="/static/themes/<?php echo $theme; ?>/assets/img/bg4.jpg" alt="Third slide">
                                        <div class="carousel-caption d-none d-md-block">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
							...
							<img src="/static/themes/<?php echo $theme; ?>/assets/img/nucleo.svg" alt="">
						</div> -->
            ...
            <div class="section section-examples" data-background-color="black">
                ...
                <div class="container text-center">
                    <div class="row">
                        <div class="col">
                            <a href="<?php echo base_url() . '?theme=' . $theme; ?>">
                                <img src="/static/themes/<?php echo $theme; ?>/assets/img/landing.jpg" alt="Image" class="img-raised">
                            </a>
                            <a href="<?php echo base_url() . '?theme=' . $theme; ?>" class="btn btn-simple btn-primary btn-round">View Landing Page</a>
                        </div>
                        <div class="col">
                            <a href="<?php echo base_url('profile') . '?theme=' . $theme; ?>">
                                <img src="/static/themes/<?php echo $theme; ?>/assets/img/profile.jpg" alt="Image" class="img-raised">
                            </a>
                            <a href="<?php echo base_url('profile') . '?theme=' . $theme; ?>" class="btn btn-simple btn-primary btn-round">View Profile Page</a>
                        </div>
                    </div>
                </div>
            </div>

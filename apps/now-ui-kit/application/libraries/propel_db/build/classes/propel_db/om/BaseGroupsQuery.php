 ...
 * @method GroupsQuery orderByTitle($order = Criteria::ASC) Order by the title column
 * @method GroupsQuery orderByDescription($order = Criteria::ASC) Order by the description column
 *
 * @method GroupsQuery groupById() Group by the id column
 * @method GroupsQuery groupByTitle() Group by the title column
 * @method GroupsQuery groupByDescription() Group by the description column
 *
 ...
 *
 * @method Groups findOneByTitle(string $title) Return the first Groups filtered by the title column
 * @method Groups findOneByDescription(string $description) Return the first Groups filtered by the description column
 *
 * @method array findById(int $id) Return Groups objects filtered by the id column
 * @method array findByTitle(string $title) Return Groups objects filtered by the title column
 * @method array findByDescription(string $description) Return Groups objects filtered by the description column
 *
...
abstract class BaseGroupsQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `title`, `description` FROM `groups` WHERE `id` = :p0';
        try {
    ...
    public function filterByTitle($title = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(GroupsPeer::TITLE, $title, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(GroupsPeer::DESCRIPTION, $description, $comparison);
    }

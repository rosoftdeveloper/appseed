...
abstract class BaseUsersPeer
{
    ...
    const IDENTIFIER = 'users.identifier';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Email', 'Password', 'GroupId', 'Token', 'Identifier', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'email', 'password', 'groupId', 'token', 'identifier', ),
        BasePeer::TYPE_COLNAME => array (UsersPeer::ID, UsersPeer::USERNAME, UsersPeer::EMAIL, UsersPeer::PASSWORD, UsersPeer::GROUP_ID, UsersPeer::TOKEN, UsersPeer::IDENTIFIER, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'EMAIL', 'PASSWORD', 'GROUP_ID', 'TOKEN', 'IDENTIFIER', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'email', 'password', 'group_id', 'token', 'identifier', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Email' => 2, 'Password' => 3, 'GroupId' => 4, 'Token' => 5, 'Identifier' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'email' => 2, 'password' => 3, 'groupId' => 4, 'token' => 5, 'identifier' => 6, ),
        BasePeer::TYPE_COLNAME => array (UsersPeer::ID => 0, UsersPeer::USERNAME => 1, UsersPeer::EMAIL => 2, UsersPeer::PASSWORD => 3, UsersPeer::GROUP_ID => 4, UsersPeer::TOKEN => 5, UsersPeer::IDENTIFIER => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'EMAIL' => 2, 'PASSWORD' => 3, 'GROUP_ID' => 4, 'TOKEN' => 5, 'IDENTIFIER' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'email' => 2, 'password' => 3, 'group_id' => 4, 'token' => 5, 'identifier' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersPeer::TOKEN);
            $criteria->addSelectColumn(UsersPeer::IDENTIFIER);
        } else {

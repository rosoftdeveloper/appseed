 ...
 * @method UsersQuery orderByGroupId($order = Criteria::ASC) Order by the group_id column
 * @method UsersQuery orderByToken($order = Criteria::ASC) Order by the token column
 * @method UsersQuery orderByIdentifier($order = Criteria::ASC) Order by the identifier column
 *
 ...
 * @method UsersQuery groupByGroupId() Group by the group_id column
 * @method UsersQuery groupByToken() Group by the token column
 * @method UsersQuery groupByIdentifier() Group by the identifier column
 *
 ...
 * @method Users findOneByGroupId(int $group_id) Return the first Users filtered by the group_id column
 * @method Users findOneByToken(string $token) Return the first Users filtered by the token column
 * @method Users findOneByIdentifier(string $identifier) Return the first Users filtered by the identifier column
 *
 ...
 * @method array findByGroupId(int $group_id) Return Users objects filtered by the group_id column
 * @method array findByToken(string $token) Return Users objects filtered by the token column
 * @method array findByIdentifier(string $identifier) Return Users objects filtered by the identifier column
 *
...
abstract class BaseUsersQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `username`, `email`, `password`, `group_id`, `token`, `identifier` FROM `users` WHERE `id` = :p0';
        try {
    ...
    public function filterByGroupId($groupId = null, $comparison = null)
    {
        if (is_array($groupId)) {
            ...
            if (isset($groupId['min'])) {
                $this->addUsingAlias(UsersPeer::GROUP_ID, $groupId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($groupId['max'])) {
                $this->addUsingAlias(UsersPeer::GROUP_ID, $groupId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersPeer::GROUP_ID, $groupId, $comparison);
    }
    ...
    public function filterByToken($token = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsersPeer::TOKEN, $token, $comparison);
    }
    ...
    public function filterByIdentifier($identifier = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsersPeer::IDENTIFIER, $identifier, $comparison);
    }

...
abstract class BaseGroups extends BaseObject implements Persistent
{
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = GroupsPeer::TITLE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = GroupsPeer::DESCRIPTION;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GroupsPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(GroupsPeer::DESCRIPTION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupsPeer::TITLE)) $criteria->add(GroupsPeer::TITLE, $this->title);
        if ($this->isColumnModified(GroupsPeer::DESCRIPTION)) $criteria->add(GroupsPeer::DESCRIPTION, $this->description);
